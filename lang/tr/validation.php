...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'avatar' => 'Avatar',
        'barcode_symbology' => 'Barkod Sembolü',
        'brand_id' => 'Marka kimliği',
        'cash_register_id' => 'Kasa kimliği',
        'category_id' => 'Kategori kimliği',
        'city' => 'Şehir',
        'code' => 'Kod',
        'country' => 'Ülke',
        'customer_group_id' => 'Müşteri grubu kimliği',
        'date' => 'Tarih',
        'default_client_id' => 'Varsayılan müşteri kimliği',
        'default_warehouse_id' => 'Varsayılan depo kimliği',
        ...
        'image' => 'Resim',
        'is_all_warehouses' => 'Tüm depolar mı',
        'mail_encryption' => 'E-POSTA ŞİFRELEME',
        'mail_from_address' => 'GÖNDEREN ADRESİ',
        'mail_from_name' => 'GÖNDEREN ADI',
        'mail_host' => 'E-POSTA SUNUCUSU',
        'mail_mailer' => 'E-POSTA GÖNDERİCİSİ',
        'mail_password' => 'E-POSTA PAROLASI',
        'mail_port' => 'E-POSTA PORTU',
        'mail_username' => 'E-POSTA KULLANICI ADI',
        'name' => 'Ad',
        'note' => 'Not',
        'password' => 'Şifre',
        'phone' => 'Telefon',
