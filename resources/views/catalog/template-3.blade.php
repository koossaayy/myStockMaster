...
@php
    ...
    $primaryColor = $templateStyles['primary_color'] ?? '#01B3F2';
                        ...
                        <header class="th-header header-layout4">
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    <p class="invoice-number"><b>{{ __('Reference No') }}: </b>#935648</p>
                                </div>
                            </div>
                        </header>
