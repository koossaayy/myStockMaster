                    ...
                    <div class="card">
                        <div class="p-4">
                                ...
                                <div class="xl:w-1/3 lg:w-1/2 sm:w-full px-3">
                                    <div class="mb-4">
                                        ...
                                        <input type="text"
                                            ...
                                            name="reference" required readonly value="{{ $saleReturnPayment->reference }}">
                                    </div>
                                </div>
                                <div class="xl:w-1/3 lg:w-1/2 sm:w-full px-3">
                                    <div class="mb-4">
                                        ...
                                        <input type="date"
                                            class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
                                            name="date" required
                                            value="{{ $saleReturnPayment->getAttributes()['date'] }}">
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            <input id="amount" type="text"
                                                ...
                                                value="{{ old('amount') ?? $saleReturnPayment->amount }}">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea
                                    class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
                                    rows="4" name="note">{{ old('note') ?? $saleReturnPayment->note }}</textarea>
                            </div>
