...
@section('content')
    <div class="px-4 mx-auto">
        <form id="payment-form" action="{{ route('purchase-return-payments.update', $purchaseReturnPayment) }}"
            method="POST">
            @csrf
            @method('patch')
            <div class="row">
                    ...
                    <div class="card">
                        <div class="p-4">
                            <div class="flex flex-wrap -mx-2 mb-3">
                                <div class="xl:w-1/3 lg:w-1/2 sm:w-full px-3">
                                    ...
                                    <input type="text"
                                        ...
                                        name="reference" required readonly value="{{ $purchaseReturnPayment->reference }}">
                                </div>
                                <div class="xl:w-1/3 lg:w-1/2 sm:w-full px-3">
                                    ...
                                    <input type="date"
                                        class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
                                        name="date" required
                                        value="{{ $purchaseReturnPayment->getAttributes()['date'] }}">
                                </div>
                                ...
                                <div class="w-full md:w-1/3 px-2 mb-2">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ format_currency($purchase_return->due_amount) }}" readonly>
                                </div>
                                <div class="w-full md:w-1/3 px-2 mb-2">
                                    <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea
                                    class="block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md mt-1"
                                    rows="4" name="note">{{ old('note') ?? $purchaseReturnPayment->note }}</textarea>
                            </div>
